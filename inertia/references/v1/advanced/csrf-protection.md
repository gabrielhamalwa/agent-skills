...
You can even use Inertia's [shared data](/docs/v1/the-basics/shared-data) functionality to automatically include the `csrf_token` with each response.
...
<video controls>
  <source src="https://mintcdn.com/inertiajs/X4AKX_y_0pX0Y95-/mp4/csrf-mismatch-modal.mp4?fit=max&auto=format&n=X4AKX_y_0pX0Y95-&q=85&s=25545a6fdb2bc79216314e656dddcad6" type="video/mp4" data-path="mp4/csrf-mismatch-modal.mp4" />
</video>
...
<video controls>
  <source src="https://mintcdn.com/inertiajs/X4AKX_y_0pX0Y95-/mp4/csrf-mismatch-warning.mp4?fit=max&auto=format&n=X4AKX_y_0pX0Y95-&q=85&s=75f0899947cae6f9ce9125edc45891ab" type="video/mp4" data-path="mp4/csrf-mismatch-warning.mp4" />
</video>
