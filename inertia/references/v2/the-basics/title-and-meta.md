...
To enable this, configure the `future.useDataInertiaHeadAttribute` option in your [application defaults](/docs/v2/installation/client-side-setup#configuring-defaults).
