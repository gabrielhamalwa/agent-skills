...
When using an [Inertia link](/docs/v2/the-basics/links), you can preserve the scroll position using the `preserveScroll` prop.
...
To use text fragments with your Inertia pages, enable [server-side rendering](/docs/v2/advanced/server-side-rendering).
