...
To enable this, configure the `future.useDialogForErrorModal` option in your [application defaults](/docs/v2/installation/client-side-setup#configuring-defaults).
