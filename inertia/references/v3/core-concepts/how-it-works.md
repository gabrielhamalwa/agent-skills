...
To learn more about the nitty-gritty, technical details of how Inertia works under the hood, check out the [protocol page](/docs/v3/core-concepts/the-protocol).
