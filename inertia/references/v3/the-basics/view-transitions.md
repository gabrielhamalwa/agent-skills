...
You may enable view transitions globally for all visits by configuring the `visitOptions` callback when [initializing your Inertia app](/docs/v3/installation/client-side-setup#configuring-defaults).
