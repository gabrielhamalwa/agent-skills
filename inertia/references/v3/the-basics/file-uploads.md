...
This example uses the [Inertia form helper](/docs/v3/the-basics/forms#form-helper) for convenience, since the form helper provides easy access to the current upload progress. However, you are free to submit your forms using [manual Inertia visits](/docs/v3/the-basics/manual-visits) as well.
