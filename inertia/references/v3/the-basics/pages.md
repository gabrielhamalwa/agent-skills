...
<ClientSpecific>
  ...
  response](/docs/v3/the-basics/responses) from a controller or route. In this
...
Most applications share common UI elements across pages. Inertia provides persistent layouts that survive page navigations, along with layout props for passing dynamic data between pages and their layouts. Visit the [layouts documentation](/docs/v3/the-basics/layouts) to learn more.
