...
Flash data lets you send one-time data to your front end that won't reappear when users navigate through browser history. Unlike regular props, flash data isn't persisted in history state, making it ideal for success messages, newly created IDs, or other temporary values.
...
You may use the global `flash` event to handle flash data in a central location, such as a layout component. For more information on events, see the [events documentation](/docs/v3/advanced/events).
...
<Warning>
  ...
  event listeners](/docs/v3/advanced/events#removing-listeners) for more information.
</Warning>
...
You may configure the flash data type globally using [TypeScript's declaration merging](/docs/v3/advanced/typescript#flash-data).

## Testing

For information on testing flash data, see the [testing documentation](/docs/v3/advanced/testing#testing-flash-data).
