...
If a request is made after the second value, the cache is considered expired, and the page and data are fetched from the server as a regular request.
