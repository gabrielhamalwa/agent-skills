...
[Horizontal Multi-Thumb Slider Example](examples/slider-multithumb.html): Demonstrates a two-thumb slider for picking a price range for a hotel reservation.



## Keyboard Interaction

- Each thumb is in the page tab sequence and has the keyboard interactions described in the [Slider Pattern](../slider/pattern.md).
