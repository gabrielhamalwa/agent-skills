...
- [Radio Group Example Using Roving tabindex](examples/radio.html)
- [Radio Group Example Using aria-activedescendant](examples/radio-activedescendant.html)
- [Rating Radio Group Example](examples/radio-rating.html): Radio group that provides input for a five-star rating scale.
...
This section describes the keyboard interaction implemented for most radio groups. For the special case of a radio group nested inside a [toolbar](../toolbar/pattern.md), use the keyboard interaction described in the following section.
...
Radio buttons in a toolbar are frequently styled in a manner that appears more like toggle buttons. For an example, See the [Simple Editor Toolbar Example](../toolbar/examples/toolbar.html).
