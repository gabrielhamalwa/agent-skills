...
- [Checkbox (Two-State) Example](examples/checkbox.html): Demonstrates a simple 2-state checkbox.
- [Checkbox (Mixed-State) Example](examples/checkbox-mixed.html): Demonstrates a checkbox that uses the mixed value for aria-checked to reflect and control checked states within a group of two-state HTML checkboxes contained in an HTML `fieldset`.
