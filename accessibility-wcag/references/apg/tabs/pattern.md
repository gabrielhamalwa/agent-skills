...
- [Tabs With Automatic Activation](examples/tabs-automatic.html): A tabs widget where tabs are automatically activated and their panel is displayed when they receive focus.
- [Tabs With Manual Activation](examples/tabs-manual.html): A tabs widget where users activate a tab and display its panel by pressing `Space` or `Enter`.
