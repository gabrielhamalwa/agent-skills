...
Because alerts are intended to provide important and potentially time-sensitive information without interfering with the user's ability to continue working, it is crucial they do not affect keyboard focus. The [Alert Dialog Pattern](../alertdialog/pattern.md) is designed for situations where interrupting work flow is necessary.
