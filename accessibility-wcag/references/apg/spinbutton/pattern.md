...
[Quantity Spin Button Example:](examples/quantity-spinbutton.html) A set of three spin buttons to collect the quantities of adults, children, and animals for a hotel reservation.
