...
See [framework support](https://storybook.js.org/docs/ai/mcp/overview.md#framework-support) for what each one produces.
...
When [`experimentalDocgenServer`](https://storybook.js.org/docs/api/main-config/main-config-features.md#experimentaldocgenserver) is enabled, prop type extraction runs server-side via React Component Meta instead, and manifests use a ref-based format with per-component JSON snapshots when combined with [`componentsManifest`](https://storybook.js.org/docs/api/main-config/main-config-features.md#componentsmanifest).
...
The [docs manifest](#docs-mdx-manifest) is generated for every framework, but the [docs toolset](https://storybook.js.org/docs/ai/mcp/overview.md#docs) stays unavailable without a components manifest to go with it.
The [development](https://storybook.js.org/docs/ai/mcp/overview.md#development) and [testing](https://storybook.js.org/docs/ai/mcp/overview.md#testing) toolsets of the [MCP server](https://storybook.js.org/docs/ai/mcp/overview.md) work regardless.
...
With [`experimentalDocgenServer`](https://storybook.js.org/docs/api/main-config/main-config-features.md#experimentaldocgenserver) enabled, the dev server returns a 404 for both JSON routes.
