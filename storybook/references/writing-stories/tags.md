...
| `manifest` | Yes                 | Stories and docs tagged with `manifest` are included in the [component or docs manifests](https://storybook.js.org/docs/ai/manifests.md), on the [frameworks that generate them](https://storybook.js.org/docs/ai/mcp/overview.md#framework-support).                                                             |
