...
| Angular (Vite)    | Your TypeScript sources, read on the Storybook server ([details](https://storybook.js.org/docs/get-started/frameworks/angular-vite.md#component-documentation)), or [compodoc](https://compodoc.app/) if you turn that off |
| Angular (Webpack) | [compodoc](https://compodoc.app/)                                                                                                                                                                |
