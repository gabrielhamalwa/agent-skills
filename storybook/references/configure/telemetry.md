...
- In-app events (e.g., [Storybook guided tour](https://github.com/storybookjs/storybook/tree/next/code/addons/onboarding), [UI test run](https://storybook.js.org/docs/writing-tests/integrations/vitest-addon/index.md#storybook-ui)).
