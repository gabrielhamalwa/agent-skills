...
The Vitest addon is supported and recommended for [React](https://storybook.js.org/docs/writing-tests/integrations/vitest-addon/?renderer=react.md), [Preact](https://storybook.js.org/docs/writing-tests/integrations/vitest-addon/?renderer=preact.md), [Vue](https://storybook.js.org/docs/writing-tests/integrations/vitest-addon/?renderer=vue.md), [Svelte](https://storybook.js.org/docs/writing-tests/integrations/vitest-addon/?renderer=svelte.md), [Web Components](https://storybook.js.org/docs/writing-tests/integrations/vitest-addon/?renderer=web-components.md), and [Angular](https://storybook.js.org/docs/writing-tests/integrations/vitest-addon/?renderer=angular.md) projects, which use the [Vite builder](https://storybook.js.org/docs/builders/vite.md) (or the [Next.js framework with Vite](https://storybook.js.org/docs/get-started/frameworks/nextjs-vite.md)).

If you are using the Webpack builder, you can use the [Storybook test runner](https://storybook.js.org/docs/writing-tests/integrations/test-runner.md) to test your stories.
...
This option mirrors the [`initialGlobals`](https://storybook.js.org/docs/essentials/toolbars-and-globals.md#globals) configuration in `.storybook/preview.*`, applied per-project instead of globally, however the plugin's own values always take precedence over Storybook's own values.
