...
Storybook's AI capabilities are currently in [preview](https://storybook.js.org/docs/releases/features.md#preview).
...
The docs toolset reads the [components manifest](https://storybook.js.org/docs/ai/manifests.md), which is off by default and is not generated by every framework.
See [framework support](https://storybook.js.org/docs/ai/mcp/overview.md#framework-support) for what your framework needs.
...
Finally, test your agent's access to the MCP server. First, make sure your Storybook is running, then run a prompt like "List all documented components". You should see a call to the [`docs-list`](https://storybook.js.org/docs/ai/mcp/overview.md#docs-list) tool with a response listing components from your Storybook.
...
Which tools your agent gets depends in part on your framework. See [framework support](https://storybook.js.org/docs/ai/mcp/overview.md#framework-support).
