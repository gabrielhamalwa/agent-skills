...
If you are on **Angular ≥ 21** and want faster builds and the [Vitest addon](https://storybook.js.org/docs/writing-tests/integrations/vitest-addon.md), consider using [`@storybook/angular-vite`](https://storybook.js.org/docs/get-started/frameworks/angular-vite.md) instead. It is a Vite-based framework with the same authoring surface and full Vitest integration support.
