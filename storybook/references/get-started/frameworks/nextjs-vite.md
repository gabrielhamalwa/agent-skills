...
Direct `.md` imports also need Vite's [`?raw` suffix](https://storybook.js.org/docs/builders/vite.md#importing-markdown-files-as-strings), which Webpack applied for you.
